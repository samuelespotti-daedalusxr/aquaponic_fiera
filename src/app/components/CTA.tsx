...
const translations = {
  it: {
    ...
    registerBtn: 'Registrati Gratuitamente',
    note: 'Riceverai conferma via email. Niente spam, promesso! 🌱',
    stat1: 'Partecipanti',
    stat2: 'Espositori',
    stat3: 'Workshop',
  ...
  en: {
    ...
    note: 'You will receive a confirmation by email. No spam, we promise! 🌱',
    stat1: 'Participants',
    stat2: 'Exhibitors',
    stat3: 'Workshops',
    stat4: 'Round Tables',
